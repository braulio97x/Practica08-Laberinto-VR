...
public class Door : MonoBehaviour {
    ...
    void Start () {
        ...
        leftDoorEndRotation = leftDoorStartRotation * Quaternion.Euler(0.0f, 0.0f, 80.0f);
        rightDoorStartRotation = rightDoor.transform.rotation;
        rightDoorEndRotation = rightDoorStartRotation * Quaternion.Euler(0.0f, 0.0f, -80.0f);
    }
